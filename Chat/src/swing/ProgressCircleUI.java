...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/assets/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/assets/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/assets/file.png")).getImage();
    }
